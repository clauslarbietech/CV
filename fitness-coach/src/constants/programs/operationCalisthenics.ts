...
export const OPERATION_CALISTHENICS: WorkoutProgram = {
  ...
  tagline: '21 days of simple moves — push, squat, core, and control.',
  subtitle: '21-Day Progressive Bodyweight Basics',
  ...
  goals: [
    'Learn push, squat, and core basics',
    'Feel more confident with bodyweight moves',
    'Build lasting strength without equipment',
    'Progress week by week at a comfortable pace',
  ],
  featured: true,
