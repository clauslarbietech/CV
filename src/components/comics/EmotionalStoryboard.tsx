...
function StoryBeat({
  ...
  return (
    ...
    >
      <View className="flex-row items-center justify-between bg-night-elevated px-3 py-2">
      ...
      <View
        className="relative overflow-hidden bg-night-card"
        style={{
          height: Math.round(width * Math.min(imageAspectRatio(panel.image, 0.75), 0.9)),
          alignItems: "center",
